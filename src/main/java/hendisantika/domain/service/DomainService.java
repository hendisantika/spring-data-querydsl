package hendisantika.domain.service;
...
import hendisantika.domain.data.QDomain;
import hendisantika.domain.data.QOtherDomain;
import hendisantika.domain.rest.model.DomainRequest;
import hendisantika.domain.rest.model.DomainResponse;
...
public class DomainService {
  ...
  public List<DomainResponse> filterDomains(final DomainRequest domainRequest) {
    ...
    val predicates = Stream.of(
        ...
        Pair.of(domain.username, domainRequest.getUsername()),
